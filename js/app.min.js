...
var cards = [
    ...
    html: `<div class="profile-image"><img src="${imagePath}/selfie.jpg" alt="Ali Raza Anjum"></div>
		<div class="profile-info">
            ...
            <td style="display: flex;justify-content: space-evenly;">
              ...
              <a href="tel://+971551997063"><i class="fa fa-phone"></i></a>
  ...
  },
  {
    ...
    html: `
			<table>
				<tbody>
					<tr><td><a target="_blank" href="https://www.emaartechnologies.com/">EMAAR</a></td><td>Dubai, UAE</td><td>Nov 2022 - Sep 2024</td><td><a href="#" onclick="modal(event)" data-title="EMAAR">Full Report</a></td></tr>
...
function modal(e) {
  ...
  if (document.querySelector(".modal." + slug)) {
	...
	var topPos = Math.floor(Math.random() * 10) + 25 + "%";
